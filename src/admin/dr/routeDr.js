...
const {getAllDr,getDr,deleteDr,updateDr,signup,addSpecialties,getAllDrSameSpec} = require('./controllerDr')
...
router.get('/getAllDrSameSpec',verifyToken(["superadmin"]),getAllDrSameSpec )
