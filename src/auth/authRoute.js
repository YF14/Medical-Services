...
router.post('/signin', check('phoneNumber').not().isEmpty().isLength({min:6,max:50}).withMessage('phoneNumber is required'), body('password').not().isEmpty().isLength({min:6,max:23}),signin )
